            ...
            <div class="card" width: 24rem;>
                <div class="card-body">
                    ...
                    <div class="mb-2 fw-bold fs-3">
                        <span>Servicio: </span>${serviceOptionText}
                    </div>
                    <div class="mb-2 fw-bold text-muted">
                        <span>Estilista: </span>${providerOptionText}
                    </div>
                    <div class="mb-2">
                        <i class="fas fa-calendar-day me-2"></i>
                        <span>Fecha: </span>${formattedSelectedDate}
                    </div>
                    <div class="mb-2 ${!Number(service.price) ? 'd-none' : ''}">
                        <i class="fas fa-cash-register me-2"></i>
                        <span>Precio: </span>${Number(service.price).toLocaleString('es-ES', { minimumFractionDigits: 0, maximumFractionDigits: 2 }).replace(',', '.')} ${service.currency}
                    </div>
                </div>
            </div>
        `);
